...
<template>
  <div class="container text-center mt-5">
    <div class="row mt-5" style="font-size: 22px">
      <div class="col" style="background-color: green; color: aliceblue">
        <div>รหัสวิชา</div>
      </div>
      <div class="col" style="background-color: green; color: aliceblue">
        <div>ชื่อวิชา</div>
  ...
  <div class="row me-5 mt-5">
    ...
    >
      <img src="../assets/icons8-shopping-basket-add-48.png" alt="bsk" />
    </div>
  </div>
  <div
    class="modal fade"
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body text-center">
          <div class="row mt-3" style="font-size: 22px">
            <div class="col">
              <div>รหัสวิชา</div>
            </div>
            <div class="col">
          ...
          <div class="row m-3" v-for="n in select.length">
            ...
            <div class="col-2">
              <button
                class="col btn btn-danger w-50"
                @click="remove_subject(n - 1)"
              >
                -
              </button>
            </div>
